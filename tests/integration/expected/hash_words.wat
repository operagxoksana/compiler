(module $hash_words.wasm
  ...
  (func $<alloc::raw_vec::RawVecInner>::deallocate (;5;) (type 0) (param i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $<alloc::alloc::Global as core::alloc::Allocator>::deallocate (;7;) (type 0) (param i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
      br_if 0 (;@1;)
