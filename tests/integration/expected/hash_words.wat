(module $hash_words.wasm
  ...
  (func $<miden_field::word::Word as core::ops::index::Index<usize>>::index (;5;) (type 4) (param i32 i32 i32) (result i32)
    block ;; label = @1
      local.get 1
      i32.const 3
      i32.gt_u
  ...
  (func $<alloc::raw_vec::RawVecInner>::current_memory (;7;) (type 5) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 4
    i32.const 4
