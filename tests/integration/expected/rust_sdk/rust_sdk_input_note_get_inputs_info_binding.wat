(component
  ...
  (core module $main (;0;)
    ...
    (export "miden:rust-sdk-input-note-get-inputs-info-binding/rust-sdk-input-note-get-inputs-info-binding@0.0.1#binding" (func $miden:rust-sdk-input-note-get-inputs-info-binding/rust-sdk-input-note-get-inputs-info-binding@0.0.1#binding))
    (elem (;0;) (i32.const 1) func $rust_sdk_input_note_get_inputs_info_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_input_note_get_inputs_info_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    (func $miden:rust-sdk-input-note-get-inputs-info-binding/rust-sdk-input-note-get-inputs-info-binding@0.0.1#binding (;2;) (type 1) (result f32)
      (local i32 f32)
      ...
      call $miden_base_sys::bindings::input_note::get_inputs_info
      local.get 0
      f32.load offset=16
      local.set 1
      local.get 0
    ...
    (func $miden_base_sys::bindings::input_note::get_inputs_info (;4;) (type 2) (param i32 f32)
      (local i32)
      global.get $__stack_pointer
      i32.const 32
      i32.sub
