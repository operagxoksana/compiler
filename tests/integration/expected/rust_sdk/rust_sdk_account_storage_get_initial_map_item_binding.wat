(component
  ...
  (core module $main (;0;)
    ...
    (export "miden:rust-sdk-account-storage-get-initial-map-item-binding/rust-sdk-account-storage-get-initial-map-item-binding@0.0.1#binding" (func $miden:rust-sdk-account-storage-get-initial-map-item-binding/rust-sdk-account-storage-get-initial-map-item-binding@0.0.1#binding))
    (elem (;0;) (i32.const 1) func $rust_sdk_account_storage_get_initial_map_item_binding::bindings::__link_custom_section_describing_imports)
    ...
    (func $<rust_sdk_account_storage_get_initial_map_item_binding::TestAccount as core::default::Default>::default (;2;) (type 1) (param i32)
      (local f32)
      i64.const 2764190884472685073
      call $intrinsics::felt::from_u64_unchecked
      local.set 1
      local.get 0
      i64.const -8911505773112514939
      call $intrinsics::felt::from_u64_unchecked
      f32.store offset=4
      local.get 0
      local.get 1
