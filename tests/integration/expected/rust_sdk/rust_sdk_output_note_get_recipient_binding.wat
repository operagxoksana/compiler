(component
  ...
  (core module $main (;0;)
    ...
    (func $miden_base_sys::bindings::output_note::get_recipient (;4;) (type 2) (param i32 f32)
      ...
      local.get 1
      local.get 2
      call $miden::protocol::output_note::get_recipient
      local.get 0
      local.get 2
      i64.load
      i64.const 32
    ...
    (func $miden::protocol::output_note::get_recipient (;6;) (type 4) (param f32 i32)
      unreachable
    )
    (data $.data (;0;) (i32.const 1048576) "\01\00\00\00\01\00\00\00")
    (@custom "rodata,miden_account" (after data) "Urust_sdk_output_note_get_recipient_binding\01\0b0.0.1\03\01\00\00\00\00\00\00\00\00\00\00\00\00")
  )
