(component
  ...
  (core module $main (;0;)
    ...
    (type (;6;) (func (param f32 f32 f32 f32 f32 f32) (result f32)))
    (table (;0;) 2 2 funcref)
    (memory (;0;) 17)
    (global $__stack_pointer (;0;) (mut i32) i32.const 1048576)
    (global $GOT.data.internal.__memory_base (;1;) i32 i32.const 0)
    (export "memory" (memory 0))
    (export "miden:rust-sdk-output-note-create-binding/rust-sdk-output-note-create-binding@0.0.1#binding" (func $miden:rust-sdk-output-note-create-binding/rust-sdk-output-note-create-binding@0.0.1#binding))
    (elem (;0;) (i32.const 1) func $rust_sdk_output_note_create_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_output_note_create_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    (func $miden:rust-sdk-output-note-create-binding/rust-sdk-output-note-create-binding@0.0.1#binding (;2;) (type 1) (result f32)
      (local i32 i32 f32)
    ...
    (func $miden_base_sys::bindings::output_note::create (;4;) (type 2) (param f32 f32 i32) (result f32)
      (local i32)
      local.get 0
      local.get 1
      local.get 2
    ...
    (func $miden::protocol::output_note::create (;9;) (type 6) (param f32 f32 f32 f32 f32 f32) (result f32)
      unreachable
    )
  ...
  (component $miden:rust-sdk-output-note-create-binding/rust-sdk-output-note-create-binding@0.0.1-shim-component (;0;)
    ...
    (type (;2;) (record (field "inner" 1)))
    (import "import-type-note-idx" (type (;3;) (eq 2)))
    (import "import-type-note-idx0" (type (;4;) (eq 3)))
    (type (;5;) (func (result 4)))
    (import "import-func-binding" (func (;0;) (type 5)))
    (export (;6;) "note-idx" (type 3))
