(component
  ...
  (core module $main (;0;)
    ...
    (elem (;0;) (i32.const 1) func $rust_sdk_account_tx_get_block_commitment_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_account_tx_get_block_commitment_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    (func $miden:base/transaction-script@1.0.0#run (;2;) (type 1) (param f32 f32 f32 f32)
      ...
      local.get 4
      call $miden_base_sys::bindings::tx::get_block_commitment
      local.get 4
      i32.const 16
      i32.add
      global.set $__stack_pointer
    ...
    (func $miden_base_sys::bindings::tx::get_block_commitment (;4;) (type 2) (param i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
