(component
  ...
  (core module $main (;0;)
    ...
    (elem (;0;) (i32.const 1) func $rust_sdk_account_tx_get_output_notes_commitment_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_account_tx_get_output_notes_commitment_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    ...
    (func $miden_base_sys::bindings::tx::get_output_notes_commitment (;4;) (type 2) (param i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden::protocol::tx::get_output_notes_commitment (;5;) (type 2) (param i32)
      unreachable
    )
