(component
  ...
  (core module $main (;0;)
    ...
    (export "miden:rust-sdk-input-note-get-recipient-binding/rust-sdk-input-note-get-recipient-binding@0.0.1#binding" (func $miden:rust-sdk-input-note-get-recipient-binding/rust-sdk-input-note-get-recipient-binding@0.0.1#binding))
    (elem (;0;) (i32.const 1) func $rust_sdk_input_note_get_recipient_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_input_note_get_recipient_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    (func $miden:rust-sdk-input-note-get-recipient-binding/rust-sdk-input-note-get-recipient-binding@0.0.1#binding (;2;) (type 1) (result i32)
      (local i32 i32)
      ...
      call $miden_base_sys::bindings::input_note::get_recipient
    ...
    (func $miden_base_sys::bindings::input_note::get_recipient (;4;) (type 2) (param i32 f32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
      ...
      local.get 1
      local.get 2
      call $miden::protocol::input_note::get_recipient
      local.get 0
      local.get 2
      i64.load
      i64.const 32
    ...
    (func $miden::protocol::input_note::get_recipient (;6;) (type 4) (param f32 i32)
      unreachable
    )
    (data $.data (;0;) (i32.const 1048576) "\01\00\00\00\01\00\00\00")
    (@custom "rodata,miden_account" (after data) "Srust_sdk_input_note_get_recipient_binding\01\0b0.0.1\03\01\00\00\00\00\00\00\00\00\00\00\00\00\00")
  )
  ...
  (component $miden:rust-sdk-input-note-get-recipient-binding/rust-sdk-input-note-get-recipient-binding@0.0.1-shim-component (;0;)
    ...
    (type (;4;) (record (field "inner" 3)))
    (import "import-type-recipient" (type (;5;) (eq 4)))
    (import "import-type-recipient0" (type (;6;) (eq 5)))
    (type (;7;) (func (result 6)))
    (import "import-func-binding" (func (;0;) (type 7)))
    (export (;8;) "recipient" (type 5))
