(component
  ...
  (core module $main (;0;)
    ...
    (elem (;0;) (i32.const 1) func $rust_sdk_account_tx_get_expiration_block_delta_binding::bindings::__link_custom_section_describing_imports)
    (func $__wasm_call_ctors (;0;) (type 0))
    (func $rust_sdk_account_tx_get_expiration_block_delta_binding::bindings::__link_custom_section_describing_imports (;1;) (type 0))
    (func $miden:base/transaction-script@1.0.0#run (;2;) (type 1) (param f32 f32 f32 f32)
      call $wit_bindgen::rt::run_ctors_once
      call $miden_base_sys::bindings::tx::get_expiration_block_delta
      drop
    )
    ...
    (func $miden_base_sys::bindings::tx::get_expiration_block_delta (;4;) (type 2) (result f32)
      call $miden::protocol::tx::get_expiration_block_delta
    )
    (func $miden::protocol::tx::get_expiration_block_delta (;5;) (type 2) (result f32)
      unreachable
    )
